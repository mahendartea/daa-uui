                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                ...
                                <li>
                                    <a href="https://digilib.uui.ac.id" class="hover:underline">E-Library</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-4">
                                    <a href="https://simtakp.uui.ac.id" class="hover:underline ">Pelayanan KTI</a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://student.uui.ac.id" class="hover:underline">KRS/KHS Online</a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://lecturer.uui.ac.id" class="hover:underline">E-Lecturer</a>
                                </li>
                                <li class="mb-4">
                                    <a href="https://elearning.uui.ac.id" class="hover:underline">E-Learning</a>
                                </li>
                            </ul>
                        </div>
                        <div>
